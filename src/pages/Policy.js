  ...
  return (
    <div style={{ marginTop: 100 }}>
      <Container className="my-5">
        ...
        <h1 className="text-danger fw-medium my-3">Privacy Policy</h1>
        <h5>
          This Terms of Use agreement was last updated: December 11, 2020. This
          Privacy Policy agreement is effective as of: March 1st, 2019
        </h5>
        <hr />
        <p>
        ...
        <h3 className="my-3">Interpretation</h3>
        <p>
        ...
        <h3 className="my-3">Definitions</h3>
        ...
        <p>
          <span className="fw-bold">Company </span>(referred to as either "the
          Company", "We", "Us" or "Our" in this Agreement) refers to EasySheba
          Platform, Assure M N Tower, Flat B1, House H/1, North-South Road,
          Block H, Aftabnagar, Dhaka-1212.
        </p>
        <p>
          <span className="fw-bold">Cookies </span>are small files that are
        ...
        <p>
          <span className="fw-bold">Country </span>refers to Bangladesh.
        </p>
        <p>
          <span className="fw-bold">Device </span>means any device that can
          access the Service such as a computer, a cellphone, or a digital
          tablet.
        </p>
        <p>
          <span className="fw-bold">Personal Data </span>is any information that
        ...
        <p>
          <span className="fw-bold">Service Provider </span> means any natural
        ...
        <p>
          <span className="fw-bold">Third-party Social Media Service </span>{" "}
        ...
        <p>
          <span className="fw-bold">Usage Data </span> refers to data collected
        ...
        <p>
          <span className="fw-bold">Website </span> refers to EasySheba
          Platform, accessible from <Link to="/">www.easysheba.com</Link>.
        </p>
        <p>
          <span className="fw-bold">You </span> means the individual accessing
        ...
        <h1 className="mt-5 mb-3">Types of Data Collected</h1>
        <h3>Personal Data</h3>
        <p>
        ...
        <h3 className="my-3">Tracking Technologies and Cookies</h3>
        <p>
        ...
        <p>
          <span className="fw-bold ms-5">Cookies or Browser Cookies </span>A
        ...
        <p>
          <span className="fw-bold ms-5">Flash Cookies </span> Certain features
          of our Service may use local stored objects (or Flash cookies) to
          collect and store information about Your preferences or Your activity
          on our Service. Flash Cookies are not managed by the same browser
          settings as those used for Browser Cookies.
        </p>
        <p>
          <span className="fw-bold ms-5">Web Beacons </span> Certain sections of
        ...
        <h5 className="fw-bold mt-5 mb-3">Necessary / Essential Cookies:</h5>
        <p>
          <span className="fw-bold">Type: </span>Session Cookies.
        </p>
        <p>
          <span className="fw-bold">Administered by: </span>Us
        </p>
        <p>
          <span className="fw-bold">Purpose: </span>These cookies are essential
        ...
        <p>
          <span className="fw-bold">Type: </span> Persistent Cookies.
        </p>
        <p>
          <span className="fw-bold">Administered by: </span>Us
        </p>
        <p>
          <span className="fw-bold">Purpose: </span>These Cookies identify if
          users have accepted the use of cookies on the Website.
        </p>
        <h5 className="fw-bold mt-5 mb-3">Functionality Cookies</h5>
        <p>
          <span className="fw-bold">Type: </span> Persistent Cookies.
        </p>
        <p>
        ...
        <p>
          <span className="fw-bold">Purpose: </span>TThese cookies allow us to
        ...
        <h3 className="fw-bold mt-5 mb-3">Use of Your Personal Data</h3>
        <p> The Company may use Personal Data for the following purposes:</p>
        <p>
          <span className="fw-bold">To provide and maintain our Service,</span>{" "}
          including to monitor the usage of our Service.
        </p>
        <p>
          <span className="fw-bold">To manage Your Account: </span> to manage
          Your registration as a user of the Service. The Personal Data You
          provide can give You access to different functionalities of the
          Service that are available to You as a registered user.
        </p>
        <p>
          <span className="fw-bold">For the performance of a contract: </span>{" "}
          the development, compliance, and undertaking of the purchase contract
          for the products, items, or services You have purchased or of any
          other contract with Us through the Service.
        </p>
        <p>
          <span className="fw-bold">To contact You: </span> To contact You by
        ...
        <p>
          <span className="fw-bold">To provide You</span> with news, special
          offers, and general information about other goods, services, and
          events that we offer that are similar to those that you have already
          purchased or enquired about unless You have opted not to receive such
          information.
        </p>
        <p>
          <span className="fw-bold">To manage Your requests: </span> To attend
          and manage Your requests to Us.
        </p>
        <p>
          <span className="fw-bold">For business transfers: </span> We may use
        ...
        <p>
          <span className="fw-bold">For other purposes: </span> We may use Your
          ...
          services, marketing, and experience.
        </p>
        <p>
          We may share Your personal information in the following situations:
        </p>
        <p>
          <span className="fw-bold ms-5"> With Service Providers: </span> We may
          share Your personal information with Service Providers to monitor and
          analyze the use of our Service, to contact You.
        </p>
        <p>
          <span className="fw-bold ms-5"> With Affiliates: </span> We may share
        ...
        <p>
          <span className="fw-bold ms-5">With business partners: </span> We may
          share Your information with Our business partners to offer You certain
          products, services, or promotions.
        </p>
        <p>
          <span className="fw-bold ms-5"> With other users: </span>when You
        ...
        <p>
          <span className="fw-bold ms-5">For other purposes: </span> We may use
          ...
          products, services, marketing, and experience.
        </p>
        <p>
          <span className="fw-bold ms-5">With Your Consent: </span>We may
          disclose Your personal information for any other purpose with Your
          consent.
        </p>
        <h3 className="fw-bold mt-5 mb-3">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="fw-bold mt-5 mb-3">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="fw-bold mt-5 mb-3">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="fw-bold mt-5 mb-3">Security of Your Personal Data</h3>
        <p>
        ...
        <h3 className="fw-bold mt-5 mb-3">Links to Other Websites</h3>
        <p>
        ...
        <h3 className="fw-bold mt-5 mb-3">Changes to this Privacy Policy</h3>
        <p>
        ...
        <h3 className="fw-bold mt-5 mb-3">Contact Us</h3>
        <p>
          If you have any questions about this Privacy Policy, You can contact
          us:
        </p>
        <ul>
          <li>By email: info@easysheba.com</li>
          <li>By phone: 01966050506</li>
        </ul>
      </Container>
    </div>
  );
